      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-dark py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="https://jarvischatbot.xyz/admin/moodphrases">Mood Phrases</a>
            <?php 
            if($_SESSION['verified'] !== "[Jarvions] ")
            {
            ...
            <div class="col-xl-4 col-lg-5">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h4 class="m-0 font-weight-bold text-white">Pattern Mood</h4>
                </div>
                <div class="card-body"> 
                  <?php
                    
                    $query = "SELECT ID FROM Data WHERE Mood IS NULL AND LENGTH(Response) > 10 LIMIT 1";
                ...
                <div class="card-footer py-3">
                  <div class="slidecontainer">
                     <form method="post" action="submit.php">
                        ...
                        <input type="hidden" name="patternid" value="<?php echo $pattern_id_grab ?>">
                        <button class="btn btn-primary btn-lg" name="moodSubmit" type="submit">Submit Mood</button>       
                        <a href="https://jarvischatbot.xyz/admin/moodphrases/" class="btn btn-primary btn-lg">Skip Mood</a>                
                      </form>
                  </div>
                  <br>
                  <h2>Live Value: <span id="demo"></span></h2>        
                  <?php 
                  echo '<h2>PatternID: '.$pattern_id_grab.'</h2>';
                  ?>
