            ...
            <div class="col-xl-4 col-lg-5">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h4 class="m-0 font-weight-bold text-white">Blocked Patterns - Loaded 25 Patterns</h4>
                </div>
                <div class="card-body"> 
                <table class="table table-hover"><tr class="bg-primary"><th class="text-white" scope="col">PatternID</th><th style="width:50%;" class="text-white" scope="col">Input</th><th class="text-white" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" scope="col">Response</th><th class="text-white" scope="col">Blocked</th></tr>
                    <tbody>
                      <?php

                        $query = "SELECT ID FROM Data WHERE Blocked = 1 ORDER BY RAND() LIMIT 25";
                        ...
                        foreach ($result as $row)
                        {
                            ...
                            $query1 = "SELECT * FROM Data WHERE ID = $pattern_id_grab";
                            ...
                            foreach ($result1 as $row)
                            {
                                ...
                                $response = strlen($response) > 50 ? substr($response,0,50)."..." : $response;
                                $input = strlen($input) > 50 ? substr($input,0,50)."..." : $input;
                            ...
                            echo '
                            <tr>
                                <th scope="row">'.$pattern_id_grab.'</th>
                                <td><b>'.$input.'</b></td>
                                <td><b>'.$response.'</b></td>
                                <td><b>'.$blocked.'</b></td>
                            </tr>
